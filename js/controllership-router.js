...
let legadoPromise=null;const modulos=new Map();const MODULO_VERSAO="20260831e";
...
const ACOES={
  ...
  input:()=>abrirTela("input","./ctrl-input-v3.js"),
  budget:()=>abrirTela("budget","./ctrl-budget-v3.js"),
  forecast:()=>abrirTela("forecast","./ctrl-forecast.js"),
