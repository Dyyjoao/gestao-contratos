...
function formulario(k){
  if(k==="visitas"){
    ...
    <section id="visitasMateriaisBox" class="form-card hidden commercial-material-config"><div class="form-card-titulo"><div><h3>Materiais de visitas e contatos</h3><p>Lista compartilhada por todas as empresas do grupo.</p></div></div><form id="visitasMaterialForm"><div class="commercial-material-add"><input id="visNovoMaterial" type="text" placeholder="Novo material" required><button class="btn-primario" type="submit">Adicionar</button></div><div id="visitasMateriaisLista" class="commercial-material-list"></div><div class="form-acoes"><button id="visMaterialConfigFechar" class="btn-secundario" type="button">Fechar</button></div><p id="visMaterialConfigMsg" class="mensagem-form"></p></form></section>`;
  }
...
function instalar(){if(!document.querySelector('link[href^="commercial-workflow.css"]')){const l=document.createElement("link");l.rel="stylesheet";l.href="commercial-workflow.css?v=4";document.head.appendChild(l)}for(const k of Object.keys(MODELOS)){montar(k);menu(k);$(k+"Novo")?.classList.toggle("hidden",!registrar(k))}montarMesa()}
instalar();
