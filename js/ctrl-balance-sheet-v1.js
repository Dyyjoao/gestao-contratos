...
.balanco-v1-pill.warn{background:#fff3e8;color:#9a4e00}.balanco-v1-reduzido{display:inline-block;border-radius:999px;padding:2px 6px;background:#eef4ff;color:#3448a8;font-size:8px;margin-left:5px}.balanco-v1-reduzido.warn{background:#fff3e8;color:#9a4e00}
