...
function montar(){
  ...
  <section id="fuelAuditoriaBox" class="hidden">
    ...
    <section class="lista-card"><div class="lista-cabecalho"><div><h3>Movimentação mensal do tanque</h3><p>Entradas = compras de diesel · Saídas = abastecimentos registrados.</p></div></div><div class="fuel-chart-legend"><span><i class="entrada"></i>Entradas / compras</span><span><i class="saida"></i>Saídas / abastecimentos</span><span><i class="saldo"></i>Saldo teórico</span></div><div id="fuelAuditoriaMeses" class="fuel-audit-months"></div></section>
